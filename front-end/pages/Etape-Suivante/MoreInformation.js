...
z-index: 100;
${props =>
    props.moreInfo !== true ? `transform: translateX(-100%);` : null}
`;

export const Overlay = styled.div`
background: #ff416c;
background: -webkit-linear-gradient(to right, #B03A2E, #700000);
background: linear-gradient(to right, #B03A2E, #700000);
...
export const LeftOverlayPanel = styled(OverlayPanel)`
    ...
    ${props => props.moreInfo !== true ? `transform: translateX(0);` : null}
`;
